...
// To do this, you only need compare the  Note at the end of the linked list
// with the Note being added (since the Note at the end  will be the current highest). 
// For instance:
...
//    - A -> 0    - B -> 2    - C -> 3    - D -> 5    - E -> 7
//    - F -> 8    - G -> 10
//  - For every '#', add one to the Note's key. If the Note's key overflows to be 
//    bigger than 11, subtract 12, and add one to the Note's Octave. This overflow
//    can happen more than once.
// 
// For Example:
// "2F" will become a Note with octave 2, and key 8.
// "3G" will become a Note with octave 3, and key 10.
// "3G#" will become a Note with octave 3, and key 11.
// "3G##" will become a Note with octave 4, and key 0.
// "3G##############" will become a Note with octave 5, and key 0.
//
